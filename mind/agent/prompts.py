...
def build_agent_system_prompt(
    ...
    prompt = (
        ...
        "- If enough information is already available, give a final answer "
        "instead of calling a tool.\n"
        "- For codebase or repo questions, inspect relevant files when "
        "codebase tools are available.\n"
        "- For commit-readiness questions, inspect project state before giving "
        "a recommendation when tools exist.\n"
        "- If the user explicitly asks you to inspect multiple files, do not "
        "return a final answer until "
        ...
        "- If a task requires several inspections, make progress one tool "
        "call at a time instead of trying "
